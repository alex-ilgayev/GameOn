...
package com.gameon.client.crossword.view;
    ...
    public static ScaleGestureDetectorProxy create(Context context, TouchImageView view)
    {
        if (android.os.Build.VERSION.SDK_INT >= 8)
        {
            try
            {
                ...
                Class<?> clazz = Class.forName("com.gameon.client.crossword.view.TouchImageView$ScaleListener");
                ...
                clazz = Class.forName("com.gameon.client.crossword.view.ScaleGestureDetectorProxy$ScaleGestureDetectorProxyFroyo");
